...
//needs a method to determine if artist is already in the array 
//by writing an equals method in Artist class
//and then calling the equals to check if artist already exists (to be put in MediaLib class)
